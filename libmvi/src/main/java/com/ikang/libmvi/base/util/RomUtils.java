package com.ikang.libmvi.base.util;
...
public class RomUtils {
    ...
    /**
     * 判断手机支不支持状态栏字体变色 miui 6以上 Flyme4以上
     * Is support status bar dark font boolean.
     *
     * @return the boolean
     */
    public static boolean isSupportStatusBarDarkFont(Activity activity) {
        return isMIUI6Later() || StatusBarProxy.setStatusBarDarkIcon(activity.getWindow(), true)
    ...
    public static String getMIUIVersion() {
        return  isXiaomi() ? getRomInfo().version : "";
    }
